...
$GLOBALS['TL_LANG']['tl_topwertungszahlen_photos']['new'] = array('Neues Foto', 'Neues Foto einbinden');
$GLOBALS['TL_LANG']['tl_topwertungszahlen_photos']['edit'] = array('Fotos des Spielers bearbeiten', 'Fotos des Spielers %s bearbeiten');
$GLOBALS['TL_LANG']['tl_topwertungszahlen_photos']['copy'] = array('Foto kopieren', 'Foto %s kopieren');
